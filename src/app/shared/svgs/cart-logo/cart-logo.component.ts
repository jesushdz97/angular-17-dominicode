...
@Component({
  ...
  imports: [],
  template: `
    <svg [attr.width]="width" [attr.height]="height" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
export class CartLogoComponent {
  @Input() width = '50px';
  @Input() height = '50px';
}
